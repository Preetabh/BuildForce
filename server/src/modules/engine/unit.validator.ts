/**
 * Physical Dimension Categories and Unit Normalization Engine
...
export class UnitDimensionEngine {
   ...
   * If an item unit is dimensionally incompatible (e.g. formula LxWxH for unit 'mm' or 'sqm'),
  ...
  public static validateDimensionalCompatibility(
    ...
    // If formula is CUSTOM or actual unit is CUSTOM, allow if non-empty
    ...
    // DIMENSIONAL MISMATCH / DATA CONFIGURATION ERROR
