...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, deletedCount }) => {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 bottom-0 left-0 z-50 w-64 bg-[#0A0D14] border-r border-[#161D2E] flex flex-col transition-transform duration-300 ease-in-out md:translate-x-0 select-none shadow-2xl',
